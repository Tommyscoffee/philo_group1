...
/*   Updated: 2022/03/12 14:15:28 by akihito          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	monitor_start(t_philo *nil, long philo_number);
...
int		take_fork_right(t_philo *philo);//done take_fork;
int		take_fork_left(t_philo *philo);//done take_fork;
...
void	create_elapsed_time(t_philo *new, int idx);
void	create_fork_left(t_philo *new, int idx);
